...
define("@scom/scom-payment-widget/interface.ts", ["require", "exports"], function (require, exports) {
    ...
    (function (PaymentMethod) {
        ...
        PaymentMethod["RewardsPoints"] = "RewardsPoints";
    })(PaymentMethod = exports.PaymentMethod || (exports.PaymentMethod = {}));
    var PaymentType;
    (function (PaymentType) {
        PaymentType["Fiat"] = "Fiat";
        PaymentType["Crypto"] = "Crypto";
        PaymentType["RewardsPoints"] = "RewardsPoints";
...
define("@scom/scom-payment-widget/components/paymentMethod.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-payment-widget/interface.ts", "@scom/scom-payment-widget/components/index.css.ts", "@scom/scom-payment-widget/translations.json.ts"], function (require, exports, components_12, interface_3, index_css_4, translations_json_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    let PaymentMethodModule = class PaymentMethodModule extends components_12.Module {
        ...
        handlePaymentType(type) {
            ...
            else if (type === interface_3.PaymentType.RewardsPoints) {
                this.model.paymentMethod = interface_3.PaymentMethod.RewardsPoints;
            ...
            return this.$render("i-stack", { direction: "vertical", alignItems: "center", width: "100%" },
                ...
                this.$render("i-stack", { direction: "vertical", gap: "1rem", width: "100%", height: "100%", alignItems: "center", padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' } },
                    ...
                    this.$render("i-stack", { id: "pnlPaymentType", direction: "vertical", gap: "1rem", width: "100%", height: "100%", alignItems: "center" },
                        ...
                        this.$render("scom-payment-widget--payment-type", { id: "pnlRewardsPointsPayment", width: "100%", type: interface_3.PaymentType.RewardsPoints, title: "$rewards_points", iconName: "star", visible: false, onSelectPaymentType: this.handlePaymentType })),
            ...
            return this.$render("i-stack", { direction: "vertical", gap: "1rem", width: "100%", alignItems: "center", padding: { top: '1rem', bottom: '1rem' } },
                this.$render("i-stack", { direction: "vertical", gap: "1rem", height: "100%", width: "100%" },
                    ...
                    this.$render("i-stack", { direction: "vertical", gap: "1rem", width: "100%", height: "100%", alignItems: "center", padding: { left: '1rem', right: '1rem' } },
                        this.$render("i-stack", { id: "pnlAddress", direction: "horizontal", justifyContent: "space-between", alignItems: "center", gap: "1rem", width: "100%", wrap: "wrap", margin: { bottom: '0.5rem' } },
...
define("@scom/scom-payment-widget/components/rewardsPointsModule.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-payment-widget/translations.json.ts"], function (require, exports, components_16, translations_json_10) {
    ...
    let RewardsPointsModule = class RewardsPointsModule extends components_16.Module {
        ...
        handleCheckboxChanged() {
            this.pnlRewardsPoints.visible = this.chkPayWithPoints.checked;
            if (this.selectedRewardsPoint && this.onPointsChanged)
                this.onPointsChanged(this.onValidate());
        }
        handlePointInputChanged() {
            const points = Number(this.edtPoints.value) || 0;
        ...
        render() {
            this.$render("i-stack", { direction: "vertical", width: "100%", height: "100%", gap: "0.25rem" },
                ...
                this.$render("i-stack", { id: "pnlRewardsPoints", direction: "vertical", width: "100%", height: "100%", margin: { top: '0.25rem' }, gap: "0.25rem", visible: false },
                    ...
                    this.$render("i-stack", { id: "pnlDetail", direction: "vertical", width: "100%", margin: { top: '1rem' }, gap: "0.25rem" },
                        this.$render("i-label", { caption: "$point_balance" }),
...
define("@scom/scom-payment-widget/components/walletPayment.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-payment-widget/interface.ts", "@scom/scom-token-list", "@scom/scom-payment-widget/store.ts", "@ijstech/eth-wallet", "@scom/scom-payment-widget/components/index.css.ts", "@scom/scom-payment-widget/translations.json.ts", "@scom/scom-payment-widget/wallets/index.ts"], function (require, exports, components_17, interface_4, scom_token_list_1, store_5, eth_wallet_3, index_css_7, translations_json_11, wallets_2) {
    ...
    (function (Step) {
        ...
        Step[Step["SelectRewardsPoint"] = 2] = "SelectRewardsPoint";
        Step[Step["Pay"] = 3] = "Pay";
    })(Step || (Step = {}));
    let WalletPayment = class WalletPayment extends components_17.Module {
        ...
        async checkWalletStatus() {
            ...
            const provider = store_5.PaymentProviders.find(v => v.provider === paymentProvider);
            if (isConnected) {
                ...
                if (provider) {
                    this.lbCurrentAddress.caption = components_17.FormatUtils.truncateWalletAddress(address);
        ...
        async handleSelectToken(token, isTon) {
            ...
            this.lbToAddress.caption = components_17.FormatUtils.truncateWalletAddress(toAddress);
            const formattedAmount = components_17.FormatUtils.formatNumber(this.amountToPay, { decimalFigures: 6, hasTrailingZero: false });
            ...
            this.tokenBalance = eth_wallet_3.Utils.fromDecimals(tokenBalance, token.decimals);
            const formattedTokenBalance = components_17.FormatUtils.formatNumber(this.tokenBalance.toFixed(), { decimalFigures: 6, hasTrailingZero: false });
            this.lblTokenBalance.caption = `${formattedTokenBalance} ${token.symbol}`;
            if (new eth_wallet_3.BigNumber(this.amountToPay).shiftedBy(token.decimals).gt(tokenBalance)) {
        ...
        async handlePay() {
            ...
            if (this.onPaid) {
                ...
                try {
                    ...
                    await this.model.walletModel.transferToken(this.model.payment.address, this.selectedToken, this.amountToPay, async (error, receipt) => {
                        this.updateBtnPay(false);
                        if (error) {
            ...
            return this.$render("i-stack", { direction: "vertical", alignItems: "center", width: "100%" },
                ...
                this.$render("i-stack", { direction: "vertical", gap: "1.5rem", width: "100%", height: "100%", alignItems: "center", padding: { top: '1rem', bottom: '1rem' } },
                    ...
                    this.$render("i-stack", { id: "pnlPay", visible: false, direction: "vertical", gap: "1rem", justifyContent: "center", alignItems: "center", height: "100%", width: "100%" },
                        ...
                        this.$render("i-stack", { id: "pnlPayDetail", visible: false, direction: "vertical", gap: "1rem", width: "100%", height: "100%", padding: { left: '1rem', right: '1rem' } },
                            this.$render("i-stack", { id: "pnlCryptoPayment", direction: "vertical", gap: "0.25rem", width: "100%" },
                                ...
                                this.$render("i-label", { caption: "$token_balance" }),
                                this.$render("i-stack", { direction: "horizontal", alignItems: "stretch", width: "100%", minHeight: 36, margin: { bottom: '1rem' }, padding: { top: '0.5rem', bottom: '0.5rem', left: '0.5rem', right: '0.5rem' }, border: { radius: 8 }, background: { color: Theme.input.background }, overflow: "hidden" },
                                    this.$render("i-label", { id: "lblTokenBalance" })),
                            ...
                            this.$render("scom-payment-widget--rewards-points-module", { id: "rewardsPointsModule", model: this.model, onBeforeSelect: this.handleBeforeSelectRewardsPoint, onSelected: this.handleSelectedRewardsPoint, onPointsChanged: this.handleRewardsPointsChanged, visible: false })),
...
define("@scom/scom-payment-widget/components/rewardsPointsPayment.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-payment-widget/components/index.css.ts", "@scom/scom-payment-widget/translations.json.ts"], function (require, exports, components_18, index_css_8, translations_json_12) {
    ...
    var Step;
    (function (Step) {
        Step[Step["SelectRewardsPoint"] = 0] = "SelectRewardsPoint";
        Step[Step["Pay"] = 1] = "Pay";
    })(Step || (Step = {}));
    let RewardsPointsPayment = class RewardsPointsPayment extends components_18.Module {
        ...
        render() {
            return (this.$render("i-stack", { direction: "vertical", alignItems: "center", width: "100%" },
                this.$render("scom-payment-widget--header", { id: "header", margin: { bottom: '1rem' }, display: "flex" }),
                this.$render("i-stack", { direction: "vertical", width: "100%", height: "100%", alignItems: "center", padding: { top: '1rem', bottom: '1rem' }, gap: "1rem" },
                    this.$render("i-stack", { id: "pnlRewardsPoints", direction: "vertical", width: "100%", height: "100%", padding: { left: '1rem', right: '1rem' }, gap: "1rem" },
                        this.$render("i-label", { font: { size: '1rem', color: Theme.text.primary, bold: true }, caption: '$select_rewards_point' }),
                        this.$render("scom-payment-widget--rewards-points-list", { id: "rewardsPointsList", width: "100%", data: this.model.oneOffRewardsPointsOptions, onSelectedRewardsPoint: this.handleSelectRewardsPoint })),
                    this.$render("i-stack", { id: "pnlPayDetail", direction: "vertical", gap: "0.25rem", width: "100%", height: "100%", padding: { left: '1rem', right: '1rem' }, visible: false },
                        this.$render("i-stack", { direction: "vertical", width: "100%", border: { width: 1, style: 'solid', color: Theme.divider, radius: 8 }, padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' }, margin: { bottom: '1rem' }, gap: "0.25rem" },
                            this.$render("i-label", { id: "lblCommunity", font: { bold: true, color: Theme.text.primary } }),
                            this.$render("i-label", { id: "lblCommunityCreator", font: { size: '0.75rem', color: Theme.text.primary }, textOverflow: "ellipsis" })),
                        this.$render("i-label", { caption: "$available_points" }),
                        this.$render("i-stack", { direction: "horizontal", alignItems: "stretch", width: "100%", minHeight: 36, padding: { top: '0.5rem', bottom: '0.5rem', left: '0.5rem', right: '0.5rem' }, border: { radius: 8 }, background: { color: Theme.input.background }, overflow: "hidden" },
                            this.$render("i-label", { id: "lblPointBalance" })),
                        this.$render("i-label", { id: "lblExchangeRate", margin: { bottom: '1rem' }, font: { size: '0.875rem', color: Theme.text.secondary } }),
                        this.$render("i-label", { caption: "$amount_to_pay" }),
                        ...
                        this.$render("i-label", { id: "lbError", font: { color: Theme.colors.error.main } })),
                    this.$render("i-stack", { direction: "horizontal", width: "100%", alignItems: "center", justifyContent: "center", margin: { top: 'auto' }, gap: "1rem", wrap: "wrap-reverse" },
                        this.$render("i-button", { id: "btnBack", caption: "$back", background: { color: Theme.colors.secondary.main }, class: index_css_8.halfWidthButtonStyle, onClick: this.handleBack }),
                        this.$render("i-button", { id: "btnPay", visible: false, caption: "$pay", background: { color: Theme.colors.primary.main }, class: index_css_8.halfWidthButtonStyle, onClick: this.handlePay })))));
        }
    };
    ...
    let PaymentModule = class PaymentModule extends components_19.Module {
        ...
        async init() {
            ...
            this.paymentMethod.onSelectedPaymentProvider = async (paymentProvider) => {
                if (paymentProvider === interface_5.PaymentProvider.Metamask || paymentProvider === interface_5.PaymentProvider.TonWallet) {
                    if (!this.walletPayment) {
                        this.walletPayment = new walletPayment_1.WalletPayment(undefined, { visible: false, class: index_css_9.elementStyle });
                ...
                else if (paymentProvider === interface_5.PaymentProvider.Stripe) {
                    if (!this.stripePayment) {
                        this.stripePayment = new stripePayment_1.StripePayment(undefined, { visible: false, class: index_css_9.elementStyle });
                    ...
                    if (!this.rewardsPointsPayment) {
                        this.rewardsPointsPayment = new rewardsPointsPayment_1.RewardsPointsPayment(undefined, { visible: false, class: index_css_9.elementStyle });
                        this.rewardsPointsPayment.model = this.model;
                        this.rewardsPointsPayment.onPaid = (paymentStatus) => {
                            this.rewardsPointsPayment.visible = false;
                            this.statusPayment.visible = true;
                            this.statusPayment.updateStatus(paymentStatus);
                        };
        ...
        render() {
            return (this.$render("i-stack", { id: "pnlPaymentModule", margin: { top: '1rem' }, direction: "vertical", width: "100%", minHeight: 480, border: { radius: 12, style: 'solid', width: 1, color: '#ffffff4d' }, overflow: "hidden" },
                this.$render("scom-payment-widget--invoice-creation", { id: "invoiceCreation", visible: false, class: index_css_9.elementStyle }),
                this.$render("scom-payment-widget--shipping-info", { id: "shippingInfo", visible: false, class: index_css_9.elementStyle }),
                this.$render("scom-payment-widget--payment-method", { id: "paymentMethod", visible: false, class: index_css_9.elementStyle }),
                this.$render("scom-payment-widget--status-payment", { id: "statusPayment", visible: false, class: index_css_9.elementStyle })));
        }
    };
...
define("@scom/scom-payment-widget/components/stripePaymentTracking.tsx", ["require", "exports", "@ijstech/components", "@scom/scom-payment-widget/components/index.css.ts", "@scom/scom-payment-widget/assets.ts", "@scom/scom-payment-widget/store.ts", "@scom/scom-payment-widget/utils.ts", "@scom/scom-payment-widget/translations.json.ts"], function (require, exports, components_20, index_css_10, assets_3, store_6, utils_2, translations_json_13) {
    ...
    let StatusPaymentTracking = class StatusPaymentTracking extends components_20.Module {
        ...
        async checkPaymentStatus() {
            ...
            this.imgStatus.url = assets_3.default.fullPath('/img/loading.svg');
            this.imgStatus.classList.add(index_css_10.loadingImageStyle);
            ...
            try {
                ...
                switch (data?.paymentIntent.status) {
                    case 'succeeded':
                        img = assets_3.default.fullPath('img/success.svg');
                    ...
                    case 'requires_payment_method':
                        ...
                        img = assets_3.default.fullPath('img/error.png');
                        break;
                    default:
                ...
                this.imgStatus.classList.remove(index_css_10.loadingImageStyle);
                if (img) {
                ...
                this.imgStatus.classList.remove(index_css_10.loadingImageStyle);
                this.imgStatus.url = assets_3.default.fullPath('img/error.png');
            }
        ...
        render() {
            return this.$render("i-stack", { direction: "vertical", gap: "1rem", height: "100%", width: "100%", alignItems: "center", padding: { top: '1rem', bottom: '1rem', left: '1rem', right: '1rem' } },
                this.$render("i-label", { caption: "$check_stripe_payment_status", font: { size: '1rem' }, class: index_css_10.textCenterStyle }),
                ...
                this.$render("i-stack", { direction: "vertical", gap: "1rem", width: "100%", alignItems: "center", margin: { top: '2rem' } },
                    ...
                    this.$render("i-label", { id: "lbStatus", class: index_css_10.textCenterStyle, font: { size: '1rem', color: Theme.text.primary, bold: true } })));
        }
    };
